        ...
        {currentMap.mapType === MAP_TYPES.STATE ? (
          <h4 className="district-confirmed">
            ...
            {(currentMapData[currentHoveredRegion.name]
              ...
              : currentHoveredRegion.name == "Anugul" ? (currentMapData["Angul"].toString().length == 1 ? t(currentMapData["Angul"].toString()[0]) : t(currentMapData["Angul"].toString()[0])+t(currentMapData["Angul"].toString()[1])+t(currentMapData["Angul"].toString()[2]))
              : currentHoveredRegion.name == "Jagatsinghapur" ? (currentMapData["Jagatsinghpur"].toString().length == 1 ? t(currentMapData["Jagatsinghpur"].toString()[0]) : t(currentMapData["Jagatsinghpur"].toString()[0])+t(currentMapData["Jagatsinghpur"].toString()[1])+t(currentMapData["Jagatsinghpur"].toString()[2])) 
